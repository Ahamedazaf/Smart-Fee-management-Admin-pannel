...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::group(['namespace' => 'SupportTeam'], function () {
        ...
        Route::group(['prefix' => 'payments', 'as' => 'payments.'], function () {
            ...
            // Route::get('records/{student_id}', [PaymentController::class, 'fetchStudentRecords'])->name('records.student');
            Route::post('record/{payment_id}/update-inline', [PaymentController::class, 'updateInline'])->name('record.update');
        });
